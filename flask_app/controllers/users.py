...
def dashboard():
    ...
    return render_template('dashboard.html', cars = cars, loggedUser=loggedUser, soldCars = soldCars)
...
def profile():
    ...
    return render_template('profile.html', boughtCars = boughtCars, loggedUser=loggedUser)
